...
insert into public.sku_master (id, makuku_sku_name, pack_type, size, piece_count, segment, target_price_per_piece, floor_price_per_piece, gross_margin_rate) values
  ('10000000-0000-4000-8000-000000000001','Makuku Slim Pants S34','pants','S',34,'BD MID',2450,2150,0.34),
  ('10000000-0000-4000-8000-000000000002','Makuku Slim Pants M32','pants','M',32,'BD MID',2550,2250,0.34),
  ('10000000-0000-4000-8000-000000000003','Makuku Slim Pants L30','pants','L',30,'BD MID',2650,2350,0.35),
  ('10000000-0000-4000-8000-000000000004','Makuku Slim Pants XL28','pants','XL',28,'BD MID',2800,2480,0.35),
  ('10000000-0000-4000-8000-000000000005','Makuku Slim Pants XXL24','pants','XXL',24,'BD MID',3050,2700,0.36),
  ('10000000-0000-4000-8000-000000000006','Makuku Comfort Pants M34','pants','M',34,'BD MID',2200,1980,0.31),
  ('10000000-0000-4000-8000-000000000007','Makuku Comfort Pants L32','pants','L',32,'BD MID',2300,2050,0.31),
  ('10000000-0000-4000-8000-000000000008','Makuku Comfort Pants XL30','pants','XL',30,'BD MID',2450,2180,0.32),
  ('10000000-0000-4000-8000-000000000009','Makuku Comfort Pants XXL26','pants','XXL',26,'BD MID',2700,2400,0.32),
  ('10000000-0000-4000-8000-000000000010','Makuku Value Pants M36','pants','M',36,'BD Eco',1950,1780,0.26),
  ('10000000-0000-4000-8000-000000000011','Makuku Value Pants L34','pants','L',34,'BD Eco',2050,1850,0.26),
  ('10000000-0000-4000-8000-000000000012','Makuku Value Pants XL32','pants','XL',32,'BD Eco',2150,1950,0.27),
  ('10000000-0000-4000-8000-000000000013','Makuku Tape NB44','tape','NB',44,'BD MID',2300,2050,0.33),
  ('10000000-0000-4000-8000-000000000014','Makuku Tape S40','tape','S',40,'BD MID',2350,2080,0.33),
  ('10000000-0000-4000-8000-000000000015','Makuku Tape M36','tape','M',36,'BD MID',2450,2180,0.34),
  ('10000000-0000-4000-8000-000000000016','Makuku Tape L32','tape','L',32,'BD MID',2600,2320,0.34),
  ('10000000-0000-4000-8000-000000000017','Makuku Tape XL28','tape','XL',28,'BD MID',2850,2540,0.35),
  ('10000000-0000-4000-8000-000000000018','Makuku Air Pants M30','pants','M',30,'BD MID',2750,2440,0.37),
  ('10000000-0000-4000-8000-000000000019','Makuku Air Pants L28','pants','L',28,'BD MID',2920,2600,0.37),
  ('10000000-0000-4000-8000-000000000020','Makuku Air Pants XL26','pants','XL',26,'BD MID',3150,2800,0.38)
on conflict (id) do nothing;
...
insert into public.competitor_products (id, brand_id, raw_title, normalized_name, channel, shop_name, product_url, image_url, pack_type, size, piece_count, segment) values
  ('20000000-0000-4000-8000-000000000001','00000000-0000-4000-8000-000000000002','MamyPoko Pants Royal Soft S34','Royal Soft Pants S34','shopee','MamyPoko Official','https://shopee.co.id/mamypoko-s34',null,'pants','S',34,'BD MID'),
  ('20000000-0000-4000-8000-000000000002','00000000-0000-4000-8000-000000000002','MamyPoko Pants Royal Soft M32','Royal Soft Pants M32','shopee','MamyPoko Official','https://shopee.co.id/mamypoko-m32',null,'pants','M',32,'BD MID'),
  ('20000000-0000-4000-8000-000000000003','00000000-0000-4000-8000-000000000002','MamyPoko Extra Dry L30','Extra Dry Pants L30','shopee','MamyPoko Official','https://shopee.co.id/mamypoko-l30',null,'pants','L',30,'BD MID'),
  ('20000000-0000-4000-8000-000000000004','00000000-0000-4000-8000-000000000002','MamyPoko Extra Dry XL28','Extra Dry Pants XL28','offline','Hypermart Bekasi',null,null,'pants','XL',28,'BD MID'),
  ('20000000-0000-4000-8000-000000000005','00000000-0000-4000-8000-000000000003','Sweety Gold Pants M34','Gold Pants M34','shopee','Sweety Official','https://shopee.co.id/sweety-m34',null,'pants','M',34,'BD MID'),
  ('20000000-0000-4000-8000-000000000006','00000000-0000-4000-8000-000000000003','Sweety Gold Pants L32','Gold Pants L32','shopee','Sweety Official','https://shopee.co.id/sweety-l32',null,'pants','L',32,'BD MID'),
  ('20000000-0000-4000-8000-000000000007','00000000-0000-4000-8000-000000000003','Sweety Bronze Pants XL32','Bronze Pants XL32','offline','Alfamart Jakarta',null,null,'pants','XL',32,'BD Eco'),
  ('20000000-0000-4000-8000-000000000008','00000000-0000-4000-8000-000000000003','Sweety Silver Pants XXL26','Silver Pants XXL26','shopee','Sweety Official','https://shopee.co.id/sweety-xxl26',null,'pants','XXL',26,'BD Eco'),
  ('20000000-0000-4000-8000-000000000009','00000000-0000-4000-8000-000000000004','Merries Good Skin Pants S34','Good Skin Pants S34','shopee','Merries Official','https://shopee.co.id/merries-s34',null,'pants','S',34,'BD MID'),
  ('20000000-0000-4000-8000-000000000010','00000000-0000-4000-8000-000000000004','Merries Good Skin Pants M32','Good Skin Pants M32','shopee','Merries Official','https://shopee.co.id/merries-m32',null,'pants','M',32,'BD MID'),
  ('20000000-0000-4000-8000-000000000011','00000000-0000-4000-8000-000000000004','Merries Pants L30','Merries Pants L30','offline','Transmart Bandung',null,null,'pants','L',30,'BD MID'),
  ('20000000-0000-4000-8000-000000000012','00000000-0000-4000-8000-000000000004','Merries Tape NB44','Tape NB44','shopee','Merries Official','https://shopee.co.id/merries-nb44',null,'tape','NB',44,'BD MID'),
  ('20000000-0000-4000-8000-000000000013','00000000-0000-4000-8000-000000000005','Goo.N Premium Pants M32','Premium Pants M32','shopee','GooN Official','https://shopee.co.id/goon-m32',null,'pants','M',32,'BD MID'),
  ('20000000-0000-4000-8000-000000000014','00000000-0000-4000-8000-000000000005','Goo.N Smile Baby L30','Smile Baby Pants L30','shopee','GooN Official','https://shopee.co.id/goon-l30',null,'pants','L',30,'BD MID'),
  ('20000000-0000-4000-8000-000000000015','00000000-0000-4000-8000-000000000005','Goo.N Smile Baby XL28','Smile Baby Pants XL28','offline','Indomaret Surabaya',null,null,'pants','XL',28,'BD MID'),
  ('20000000-0000-4000-8000-000000000016','00000000-0000-4000-8000-000000000005','Goo.N Tape S40','Tape S40','shopee','GooN Official','https://shopee.co.id/goon-s40',null,'tape','S',40,'BD MID'),
  ('20000000-0000-4000-8000-000000000017','00000000-0000-4000-8000-000000000006','Pampers Premium Care Pants M32','Premium Care Pants M32','shopee','Pampers Official','https://shopee.co.id/pampers-m32',null,'pants','M',32,'BD MID'),
  ('20000000-0000-4000-8000-000000000018','00000000-0000-4000-8000-000000000006','Pampers Premium Care Pants L30','Premium Care Pants L30','shopee','Pampers Official','https://shopee.co.id/pampers-l30',null,'pants','L',30,'BD MID'),
  ('20000000-0000-4000-8000-000000000019','00000000-0000-4000-8000-000000000006','Pampers Baby Dry Pants XL30','Baby Dry Pants XL30','offline','Lottemart Jakarta',null,null,'pants','XL',30,'BD MID'),
  ('20000000-0000-4000-8000-000000000020','00000000-0000-4000-8000-000000000006','Pampers Tape M36','Tape M36','shopee','Pampers Official','https://shopee.co.id/pampers-tape-m36',null,'tape','M',36,'BD MID'),
  ('20000000-0000-4000-8000-000000000021','00000000-0000-4000-8000-000000000002','MamyPoko Tape L32','Tape L32','shopee','MamyPoko Official','https://shopee.co.id/mamypoko-tape-l32',null,'tape','L',32,'BD MID'),
  ('20000000-0000-4000-8000-000000000022','00000000-0000-4000-8000-000000000003','Sweety Tape XL28','Tape XL28','manual','Manual Entry',null,null,'tape','XL',28,'BD MID'),
  ('20000000-0000-4000-8000-000000000023','00000000-0000-4000-8000-000000000004','Merries Pants XL28','Merries Pants XL28','shopee','Merries Official','https://shopee.co.id/merries-xl28',null,'pants','XL',28,'BD MID'),
  ('20000000-0000-4000-8000-000000000024','00000000-0000-4000-8000-000000000005','Goo.N Pants XXL24','Premium Pants XXL24','tiktok','GooN TikTok Shop',null,null,'pants','XXL',24,'BD MID'),
  ('20000000-0000-4000-8000-000000000025','00000000-0000-4000-8000-000000000006','Pampers Pants S34','Premium Care Pants S34','tiktok','Pampers TikTok Shop',null,null,'pants','S',34,'BD MID')
on conflict (id) do nothing;
...
select p.id, p.channel,
  p.piece_count * (case p.segment when 'BD MID' then 2450 when 'BD Eco' then 2150 when 'AD' then 2850 else 2150 end),
  p.piece_count * (case p.segment when 'BD MID' then 2250 when 'BD Eco' then 1980 when 'AD' then 2600 else 1980 end) - ((n % 3) * 2500),
