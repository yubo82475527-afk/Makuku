...
export const demoCompetitors: CompetitorProduct[] = [
  ["c1", "b2", "MamyPoko Pants Royal Soft M32", "Royal Soft Pants M32", "shopee", "MamyPoko Official", "pants", "M", 32, "BD MID", "s2", 0.94, true],
  ["c2", "b3", "Sweety Gold Pants L32", "Gold Pants L32", "shopee", "Sweety Official", "pants", "L", 32, "BD MID", "s7", 0.91, true],
  ["c3", "b4", "Merries Pants L30", "Merries Pants L30", "offline", "Transmart Bandung", "pants", "L", 30, "BD MID", "s3", 0.9, true],
  ["c4", "b5", "Goo.N Premium Pants M32", "Premium Pants M32", "shopee", "GooN Official", "pants", "M", 32, "BD MID", "s2", 0.88, false],
  ["c5", "b6", "Pampers Baby Dry Pants XL30", "Baby Dry Pants XL30", "offline", "Lottemart Jakarta", "pants", "XL", 30, "BD MID", "s8", 0.86, false],
  ["c6", "b4", "Merries Tape NB44", "Tape NB44", "shopee", "Merries Official", "tape", "NB", 44, "BD MID", "s13", 0.93, true],
  ["c7", "b2", "MamyPoko Tape L32", "Tape L32", "shopee", "MamyPoko Official", "tape", "L", 32, "BD MID", "s16", 0.87, false],
  ["c8", "b6", "Pampers Premium Care S34", "Premium Care Pants S34", "tiktok", "Pampers TikTok Shop", "pants", "S", 34, "BD MID", "s1", 0.82, false],
