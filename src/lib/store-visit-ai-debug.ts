  ...
  return {
    ...
    price_insights: {
      ...
      key_sku_prices: rows.map((row) => ({
        ...
        piece_count_text: row.piece_count_text,
        list_price_text: row.list_price_text,
        package_price_text: row.package_price_text,
        net_price_text: row.net_price_text,
        visible_price_per_piece_text: row.visible_price_per_piece_text,
